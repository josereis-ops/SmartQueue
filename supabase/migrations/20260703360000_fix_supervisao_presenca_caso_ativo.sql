-- Fix Sala de Controlo: caso activo só com presença Disponível/Trabalho manual;
-- forcar_estado_operador alinha com atualizar_presenca (suspende só se estado o exige).
...
-- Patch mínimo em obter_dados_supervisao: caso activo no card só se presença mantém caso
...
BEGIN
  ...
  LOOP
    ...
    v_caso_ativo.id_externo := NULL;
    v_caso_ativo.inicio_tratamento := NULL;
    v_caso_ativo.id := NULL;
